...
var REFINERS = map[int]func(*[]byte, BaseCommand) RawGameCommand{
	// task
	0: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{
			unpackInt32,
			unpackInt32,
			unpackInt32,
	...
	// research
	1: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// train
	2: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// build
	3: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// setGatherPoint
	4: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// delete
	7: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// stop
	9: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// useProtoPower
	12: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	13: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// ungarrison
	14: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// resign
	16: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// unknown 18
	18: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// tribute
	19: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// finishUnitTransform
	23: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// setUnitStance
	25: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// changeDiplomacy
	26: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// townBell
	34: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// autoScoutEvent
	35: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	37: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt8, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// repair
	38: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// taunt
	41: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// cheat
	44: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// cancelQueuedItem
	45: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// setFormation
	48: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// startUnitTransform
	53: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// unknown 55
	55: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// autoqueue
	66: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	67: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32, unpackInt8}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// timeshift
	68: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// buildWallConnector
	69: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// seekShelter
	71: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
		inputTypes := []func() int{unpackInt32, unpackInt32}
		byteLength := 0
		for _, f := range inputTypes {
			byteLength += f()
	...
	// prequeueTech
	72: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
	...
	// prebuyGodPower
	75: func(data *[]byte, baseCommand BaseCommand) RawGameCommand {
